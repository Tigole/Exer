...
public:
	TiXmlBase()	: location(),	userData(nullptr)		{}
	virtual ~TiXmlBase()			{}
...
public:
	...
	TiXmlAttribute( const std::string& _name, const std::string& _value ) : TiXmlBase(),
	document(nullptr),
	name(_name),
	value(_value),
	prev(nullptr),
	...
	TiXmlAttribute( const char * _name, const char * _value ) : TiXmlBase(),
	document(nullptr),
	name(_name),
	value(_value),
	prev(nullptr),
...
public:
	...
	*/
	TiXmlText (const char * initValue ) : TiXmlNode (TiXmlNode::TINYXML_TEXT), cdata(false)
	{
		SetValue( initValue );
		//cdata = false;
	}
	...
	#ifdef TIXML_USE_STL
	/// Constructor.
	TiXmlText( const std::string& initValue ) : TiXmlNode (TiXmlNode::TINYXML_TEXT),cdata(false)
	{
		SetValue( initValue );
		//cdata = false;
	}
	...
	TiXmlText( const TiXmlText& copy ) : TiXmlNode( TiXmlNode::TINYXML_TEXT ),cdata()	{ copy.CopyTo( this ); }
...
public:
	...
	TiXmlHandle( TiXmlNode* _node ) : node(_node)					{ /*this->node = _node;*/ }
	/// Copy constructor
	TiXmlHandle( const TiXmlHandle& ref ):node(ref.node)			{ /*this->node = ref.node;*/ }
